...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  stack1 = helpers._triageMustache.call(depth0, "model.owner", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("</td>\n						</tr>\n						<tr>\n							<th>Inkom: </th>\n							<td>");
  stack1 = helpers._triageMustache.call(depth0, "model.created_at", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("</td>\n						</tr>\n						<tr>\n							<th>Titel: </th>\n							<td>");
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("</td>\n					</tr>\n\n					<tr>\n						<th>form_library: </th>\n						<td>");
  stack1 = helpers._triageMustache.call(depth0, "model.form_library", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("</td>\n					</tr>\n					<tr>\n						<th>Leveransplats: </th>\n						<td>");
...
function program3(depth0,data) {
  ...
  data.buffer.push("\n					<tr>\n\n		    			<td>");
  stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(4, program4, data),contexts:[depth0,depth0],types:["STRING","ID"],data:data},helper ? helper.call(depth0, "fjarrinpost", "item.order_id", options) : helperMissing.call(depth0, "link-to", "fjarrinpost", "item.order_id", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push(" </td>\n		    			<td>");
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("</td>\n						<td>\n							");
  stack1 = helpers['if'].call(depth0, "item.owner", {hash:{},hashTypes:{},hashContexts:{},inverse:self.program(8, program8, data),fn:self.program(6, program6, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n						</td>\n		    		</tr>\n		    	");
  return buffer;
  }
...
function program8(depth0,data) {
  ...
  data.buffer.push("<div class=\"container\">\n	<div class=\"row\">\n		<div class=\"col-xs-12\">	\n			<div id=\"toolbar\">	\n				<div class=\"btn-group\">\n				  <button type=\"button\" class=\"btn btn-default btn-sm\">GM</button>\n				  <button type=\"button\" class=\"btn btn-default btn-sm dropdown-toggle\" data-toggle=\"dropdown\">\n				    <span class=\"caret\"></span>\n				    <span class=\"sr-only\">Toggle Dropdown</span>\n				  </button>\n				  <ul class=\"dropdown-menu\" role=\"menu\">\n				    <li><a href=\"#\">Humanistiska</a></li>\n				    <li><a href=\"#\">Pedagogen</a></li>\n				    <li><a href=\"#\">Geo</a></li>\n				    <li><a href=\"#\">Ekonomiska</a></li>\n				  </ul>\n				</div>\n				<a href=\"#\" class=\"btn btn-default btn-sm\">Mina Ordrar</a>	\n				<a href=\"#\" class=\"btn btn-default btn-sm\">Lån <i class=\"fa fa-check\"></i></a>	\n				<a href=\"#\" class=\"btn btn-default btn-sm\">Kopia <i class=\"fa fa-check\"></i></a>	\n			</div>\n		</div>\n	</div>\n	<div id=\"order-list\" class=\"row\">\n		<div class=\"col-xs-12\">\n		    <table class=\"table table-striped table-condensed\">\n		    	<tr>\n		    		");
